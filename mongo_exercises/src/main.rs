...
fn main() -> mongodb::error::Result<()> {
    ...
    // let mut client_options = ClientOptions::parse("mongodb://root:root@127.0.0.1:27017")?;
    ...
    // let docs = vec![
    //     doc! { "_id": 00000008 , "item": "Camera", "qty": 23, "status": "B", "size": { "h": 10, "w": 33, "uom": "mm"} },
    //     doc! { "_id": 00000009 , "item": "Air pods", "qty": 23, "status": "B", "size": { "h": 10, "w": 33, "uom": "mm"} },
    //     doc! { "_id": 00000010 , "item": "Wireless Charger", "qty": 23, "status": "B", "tags": ["Blue", "Green"] },
    // ];
    ...
    // let filter = doc! { "name": "key1" };
    // let replacement = doc! { "blood_group": 23};
    // let replaced_records = collection.find_one_and_replace(filter, replacement, None);
